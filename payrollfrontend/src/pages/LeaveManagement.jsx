...
const LeaveManagement = () => {
  ...
  const exportCSV = () => {
    const csv = leaves
      .map(
        (l) =>
          `${l.employee.name},${l.type},${format(
            new Date(l.startDate),
            "PPP"
          )},${format(new Date(l.endDate), "PPP")},${l.status}`
      )
      .join("\n");
          ...
          <tbody>
            {leaves.map((l, idx) => (
              ...
              >
                ...
                <td className="p-3">{format(new Date(l.startDate), "PPP")}</td>
                <td className="p-3">{format(new Date(l.endDate), "PPP")}</td>
                <td className="p-3">
                  <span
